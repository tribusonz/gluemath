/*******************************************************************************
	...
	License: GPL + X11(MIT)
*******************************************************************************/
#ifndef GML_QUADRANT_FLT_INTERNAL
#define GML_QUADRANT_FLT_INTERNAL

#if defined(__cplusplus)
extern "C" {
#endif

// uses math library: atanf()
...
static inline float
quadrantf_core(register float x, register float y)
{
	static const float PI = 3.14159265358979323846;
	register float atanxy = 0.0;
...
#endif /* GML_QUADRANT_FLT_INTERNAL */
