/*******************************************************************************
	GLUE-Math Library: Complex Division
...
*******************************************************************************/
#ifndef GML_DIV_DBLCMPLX_INTERNAL
#define GML_DIV_DBLCMPLX_INTERNAL
...
cdiv_core(dcomplex x, dcomplex y)
{
	double w, d;
	dcomplex z;
...
#endif /* GML_DIV_DBLCMPLX_INTERNAL */
