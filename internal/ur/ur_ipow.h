/*******************************************************************************
	GLUE-Math Library: Integer Power (double)
...
*******************************************************************************/
#ifndef GML_INTPOWER_DBL_INTERNAL
#define GML_INTPOWER_DBL_INTERNAL
...
ur_ipow(register double x, register int n)
{
	register int abs_n;
	register double r;
...
#endif /* GML_INTPOWER_DBL_INTERNAL */
