/*******************************************************************************
	GLUE-Math Library: Complex Power (float)
	
	Author: Hironobu Inatsuka aka tribusonz
	License: GPL + X11(MIT)
*******************************************************************************/
#ifndef GML_POW_FLTCMPLX_INTERNAL
#define GML_POW_FLTCMPLX_INTERNAL
...
cpowf_core(fcomplex c1, fcomplex c2)
{
	...
	{
		c3.real = powf_core(c1.real, c2.real);
		c3.imag = 0;
	}
	else // complex solution
	{
		...
		case 0x4242: case 0x4244: case 0x4424: case 0x4444:
			c3 = cexpf_core(fc_mul(c2, clogf_core(c1)));
			break;
		// not appear
		default:
			c3.real = NAN;
...
#endif /* GML_POW_FLTCMPLX_INTERNAL */
