...
//   uses static function: makewt, cftfsub, cftbsub
void
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, cftfsub, cftbsub, rftfsub, rftbsub
void
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, cftfsub, cftbsub, rftfsub, rftbsub, dctsub
void
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, cftfsub, cftbsub, rftfsub, rftbsub, dstsub
void
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, cftfsub, rftfsub, dctsub
void
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, cftfsub, rftfsub, dstsub
void
...
//   uses math library: (nothing)
//   uses static function: bitrv2, bitrv216, bitrv208, cftf1st, cftrec4,
//                         cftleaf, cftfx41, cftf161, cftf081, cftf040, cftx020
//   uses static function (thread): cftrec4_th
static void
...
//   uses math library: (nothing)
//   uses static function: bitrv2conj, bitrv216neg, bitrv208neg, cftb1st, cftrec4
//                         cftleaf, cftfx41, cftf161, cftf081, cftb040, cftx020
//   uses static function (thread): cftrec4_th
static void
...
//   uses math library: (nothing)
//   uses static function (thread): *cftrec1_th, *cftrec2_th
static void
...
//   uses math library: (nothing)
//   uses static function: cfttree, cftleaf, cftmdl1
static void *
cftrec1_th(void *p)
{
...
//   uses math library: (nothing)
//   uses static function: cfttree, cftleaf, cftmdl2
static void *
cftrec2_th(void *p)
{
	int isplt, j, k, m, n, n0, nw;
...
//   uses math library: (nothing)
//   uses static function: cftmdl1, cftmdl2
static int
...
//   uses math library: (nothing)
//   uses static function: cftmdl1, cftmdl2, cftf161, cftf162, cftf081, cftf082
static void
...
//   uses math library: (nothing)
//   uses static function: cftf161, cftf162, cftf081, cftf082
static void
