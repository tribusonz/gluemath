...
int ***
alloc_3d_int(int n1, int n2, int n3)
{
	int ***iii, **ii, *i;
	int j;
...
double ***
alloc_3d_double(int n1, int n2, int n3)
{
	double ***ddd, **dd, *d;
	int j;
