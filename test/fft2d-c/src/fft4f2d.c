...
//   uses static function: makewt, bitrv2col, bitrv2row, cftbcol, cftbrow,
//                         cftfcol, cftfrow
void
cdft2d(int n1, int n2, int isgn, double **a, int *ip, double *w)
{
	int n;
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, bitrv2col, bitrv2row, cftbcol,
//                         cftbrow, cftfcol, cftfrow, rftbcol, rftfcol
void
rdft2d(int n1, int n2, int isgn, double **a, int *ip, double *w)
{
	int n, nw, nc, n1h, i, j;
	double xi;
...
//   uses math library: (nothing)
//   uses static function: makewt, makect, bitrv2col, bitrv2row, cftbcol, cftbrow,
//                         cftfcol, cftfrow, rftbcol, rftfcol, dctbsub, dctfsub
void
